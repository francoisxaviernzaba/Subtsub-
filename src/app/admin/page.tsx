...
export default async function AdminPage() {
  ...
  return (
    <AdminClient
      ...
      campaigns={campaigns.map((c: any) => ({ id: c.id, ownerId: c.ownerId, ownerEmail: c.owner.email, type: c.type, status: c.status, title: c.title, spent: c.spentBudget, budget: c.totalBudget, completed: c.completedActions, max: c.maxActions, createdAt: c.createdAt.toISOString() }))}
