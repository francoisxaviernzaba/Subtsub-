  ...
  return (
    <div className="max-w-3xl mx-auto space-y-4">
      ...
      <div className="card p-6 space-y-4 text-sm text-ink-500 leading-relaxed">
        ...
        <p>Sub4sub groups sometimes require channel access or personal information, putting your account at risk. SUB2SUB uses Public channel verification, meaning we never ask for your password and cannot modify your channel. Your account remains fully secure.</p>
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Public channel verification — no password or token required</li>
